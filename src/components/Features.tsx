      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            AI-implementering <br className="hidden sm:block" />för svenska SME:er
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Vi erbjuder skräddarsydda AI-lösningar anpassade för svenska småföretag med låg AI-kompetens.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <FeatureCard
            ...
            title="SME-Fokus"
            description="Specialiserat på små och medelstora företag med kostnadseffektiva lösningar anpassade för era behov."
            index={5}
          />
        </div>
      </div>
