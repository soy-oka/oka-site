      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-10 space-y-6 sm:space-y-8">
          ...
          <div
            ...
            className="group relative overflow-hidden rounded-[28px] border border-indigo-900/30 bg-gradient-to-br from-[#14103d] via-[#1d2469] to-[#273c97] px-6 py-8 sm:px-12 sm:py-14 shadow-[0_30px_60px_rgba(24,38,94,0.35)] transition-all duration-500 hover:shadow-[0_36px_80px_rgba(24,38,94,0.42)]"
            >
