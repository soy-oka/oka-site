      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2">
          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">
            {/* Card Header with tailored gradient */}
            <div
              className="relative h-48 sm:h-64 p-6 sm:p-8 flex items-end"
              style={{
                background: 'linear-gradient(135deg, #1f1b8d 0%, #4232c9 45%, #8c49f2 100%)'
              }}
            >
          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-elegant">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, #2139c8 0%, #4a4ff1 45%, #9b6bff 100%)'
              }}
            >
